...
Write-Host "1/4 - Publicando EcoData Escolar..." -ForegroundColor Cyan
$destDir=Join-Path (Get-Location) "public\student-projects\grade-08\white\ecodata-escolar"
[System.IO.Directory]::CreateDirectory($destDir) | Out-Null
[System.IO.File]::Copy(
  (Join-Path $installerRoot "public\student-projects\grade-08\white\ecodata-escolar\index.html"),
...
Write-Host ""
Write-Host "8TH WHITE · ECODATA ESCOLAR PUBLICADO Y VALIDADO" -ForegroundColor Green
Write-Host ""
Write-Host "Revisa:"
Write-Host " http://localhost:3000/students/grade/8/white"
Write-Host " http://localhost:3000/student-projects/grade-08/white/ecodata-escolar/index.html"
