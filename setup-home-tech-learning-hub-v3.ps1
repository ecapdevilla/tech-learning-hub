...
'@ | Write-Utf8File -Path "src/shared/components/ui/LanguageSwitcher.tsx"
...
'@ | Write-Utf8File -Path "src/shared/components/layout/Navbar.tsx"
...
'@ | Write-Utf8File -Path "src/modules/grades/components/GradeCard.tsx"
...
'@ | Write-Utf8File -Path "src/app/grades/[grade]/page.tsx"
...
'@ | Write-Utf8File -Path "src/app/explore/page.tsx"
...
'@ | Write-Utf8File -Path "src/app/globals.css"
...
Write-Host ""
Write-Host "HOME creado correctamente con script V3." -ForegroundColor Green
Write-Host ""
