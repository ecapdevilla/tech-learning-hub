...
Write-Host "1/4 - Publicando EcoData de 8th White..." -ForegroundColor Cyan
$destDir=Join-Path (Get-Location) "public\student-projects\grade-08\white\ecodata"
[System.IO.Directory]::CreateDirectory($destDir) | Out-Null
[System.IO.File]::Copy(
 (Join-Path $installerRoot "public\student-projects\grade-08\white\ecodata\index.html"),
 (Join-Path $destDir "index.html"),
 $true
)

Write-Host "2/4 - Registrando proyecto..." -ForegroundColor Cyan
...
if(-not $catalog.Contains($id)){
 ...
 Write-Host "   Ya estaba registrado; no se duplica." -ForegroundColor DarkGray
}
...
Write-Host ""
Write-Host "8TH WHITE · ECODATA PUBLICADO Y VALIDADO" -ForegroundColor Green
Write-Host "Revisa:"
Write-Host " http://localhost:3000/students/grade/8/white"
Write-Host " http://localhost:3000/student-projects/grade-08/white/ecodata/index.html"
