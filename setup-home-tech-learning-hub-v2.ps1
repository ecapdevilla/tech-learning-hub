...
'@ | Out-File -FilePath "src/shared/components/ui/LanguageSwitcher.tsx" -Encoding utf8 -Force
...
'@ | Out-File -FilePath "src/shared/components/layout/Navbar.tsx" -Encoding utf8 -Force
...
'@ | Out-File -FilePath "src/shared/components/layout/SiteLayout.tsx" -Encoding utf8 -Force
...
'@ | Out-File -FilePath "src/modules/grades/components/GradeCard.tsx" -Encoding utf8 -Force
...
'@ | Out-File -FilePath "src/app/page.tsx" -Encoding utf8 -Force
...
'@ | Out-File -FilePath "src/app/grades/[grade]/page.tsx" -Encoding utf8 -Force
...
'@ | Out-File -FilePath "src/app/explore/page.tsx" -Encoding utf8 -Force
...
'@ | Out-File -FilePath "src/app/resources/page.tsx" -Encoding utf8 -Force
...
Write-Host ""
Write-Host "HOME creado correctamente con script V2." -ForegroundColor Green
Write-Host ""
